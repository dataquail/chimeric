...
import { mockUnarchiveArchivedTodo } from '@/__test__/network/archivedTodo/mockUnarchiveArchivedTodo';
import { mockDeleteArchivedTodo } from '@/__test__/network/archivedTodo/mockDeleteArchivedTodo';

describe('ArchivedTodoServiceImpl', () => {
  ...
  const getArchivedTodoService = () => {
    return getContainer().archivedTodoService;
  };
  ...
  it('getAll returns paginated archived todos', async () => {
    ...
    const archivedTodoService = getArchivedTodoService();
