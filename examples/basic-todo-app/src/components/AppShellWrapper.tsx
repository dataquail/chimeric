      ...
      <AppShell.Navbar p="md">
        <>
          <NavLink
            to="/"
            label="Active Todos"
            active={window.location.pathname === '/basic-todo-app/'}
          ...
          <NavLink
            ...
            active={
              window.location.pathname === '/basic-todo-app/saved-for-later'
            }
          ...
          <NavLink
            to="/review"
            label="Review Todos"
            active={window.location.pathname === '/basic-todo-app/review'}
