      ...
      <AppShell.Navbar p="md">
        <>
          <NavLink
            to="/"
            label="Active Todos"
            active={window.location.pathname === '/redux-todo-app/'}
          ...
          <NavLink
            ...
            active={
              window.location.pathname === '/redux-todo-app/saved-for-later'
            }
          ...
          <NavLink
            to="/review"
            label="Review Todos"
            active={window.location.pathname === '/redux-todo-app/review'}
