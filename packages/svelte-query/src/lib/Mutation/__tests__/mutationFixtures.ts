    ...
    getIdiomatic: () => {
      const fn = vi.fn(
        async (_allOptions?: {
          ...
          nativeOptions?: SvelteIdiomaticMutationNativeOptions<void, string, Error>;
        }) => 'test',
      );
      return {
        fn,
    ...
    getReactive: () => {
      const invokeFn = vi.fn(
        async (_allInvokeOptions?: {
          ...
          nativeOptions?: SvelteMutationReactiveInvokeOptions<void, string, Error>;
        }) => 'test',
      );
      const fn = vi.fn(
        (_allOptions?: {
          options?: ReactiveMutationOptions;
          nativeOptions?: SvelteMutationReactiveNativeOptions<void, string, Error>;
        }) => ({
          invoke: invokeFn,
          isIdle: true,
          isPending: false,
          ...
          data: 'test',
          reset: vi.fn(),
          native: undefined as unknown as SvelteMutationReactiveReturnType<
            void,
            string,
            Error
          >,
  ...
  withParams: {
    ...
    getReactive: () => {
      ...
      const fn = vi.fn(
        (_allOptions?: {
          options?: ReactiveMutationOptions;
          nativeOptions?: SvelteMutationReactiveNativeOptions<
            { name: string },
            string,
            Error
          >;
