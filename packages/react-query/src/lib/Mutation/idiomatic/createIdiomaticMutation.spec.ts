...
describe('createIdiomaticMutation', () => {
  ...
  it('USAGE: no params', async () => {
    ...
    const resultWithOptions = await idiomaticMutation(allOptions);
    expect(idiomaticMutation).toHaveBeenCalledWith(allOptions);
  ...
  it('USAGE: optional params', async () => {
    ...
    const resultWithoutParamsWithOptions = await idiomaticMutation(
      undefined,
      allOptions,
    );
    expect(idiomaticMutation).toHaveBeenCalledWith(undefined, allOptions);
