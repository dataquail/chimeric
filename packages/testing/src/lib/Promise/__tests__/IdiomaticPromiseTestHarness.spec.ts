import { IdiomaticPromiseTestHarness } from '../IdiomaticPromiseTestHarness';
import { createIdiomaticPromise } from '@chimeric/core';

describe('IdiomaticPromiseTestHarness', () => {
  ...
  it('should wait for success', async () => {
    ...
    const promise = IdiomaticPromiseTestHarness({
      idiomaticPromise: createIdiomaticPromise(mockPromise),
    });
