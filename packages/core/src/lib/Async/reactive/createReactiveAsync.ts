...
>(
  reactiveFn: ReactiveAsync<void, TResult, TError>['useHook'],
...
export function createReactiveAsync<
  ...
  TError extends Error = Error,
>(
  reactiveFn: ReactiveAsync<TParams | undefined, TResult, TError>['useHook'],
...
export function createReactiveAsync<
  ...
  TError extends Error = Error,
>(
  reactiveFn: ReactiveAsync<TParams, TResult, TError>['useHook'],
