...
>(args: {
  idiomatic: IdiomaticInfiniteQuery<TParams, TPageData, TPageParam, TNativeIdiomaticOptions>;
...
> {
  if (
    ...
    throw new Error('chimericFn is not qualified to be chimeric infinite query');
  }
}